...
const Layout: React.FC<LayoutProps> = ({ children, title }) => {
  return (
    <div className="min-h-screen bg-temple-50 text-stone-800 font-sans flex flex-col relative overflow-hidden">
      ...
      <div className="absolute top-[-10%] right-[-10%] w-[50vh] h-[50vh] bg-temple-100 rounded-full blur-3xl opacity-60 pointer-events-none" />
      <div className="absolute bottom-[10%] left-[-10%] w-[40vh] h-[40vh] bg-stone-200 rounded-full blur-3xl opacity-40 pointer-events-none" />
